...
## Post-V1 / Pocketed Ideas

- Cascading horizontal-loop incremental builder with purchasable downstream
  loops, buildings, and upgrades. Deliberately deferred until Presence V1.0;
  see `FUTURE_IDEAS.md`.
