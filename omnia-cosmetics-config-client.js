...
var OMNIA_ENTITIES = [
  ...
  { id:'seraph', name:'Seraph', cost:34000, _price:34000, color:'#f3d486', sub:'A biblically accurate angel — wheels within wheels, eyes of flame' }
];
...
var OMNIA_HUE_FROM_BLUE = {
  ...
  omnia:0, noema:0, aurel:182, elys:74, seraph:182
};

// Native and automatically unlocked palettes keep form artwork and swatches aligned.
var OMNIA_ENTITY_NATIVE_PALETTE = { omnia:'aether', noema:'aether', aurel:'solar', elys:'violet', seraph:'solar' };
var OMNIA_ENTITY_AUTO_PALETTE = { noema:'violet', aurel:'solar', elys:'violet', seraph:'solar' };
